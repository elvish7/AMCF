...
def predict_rate(user_list, item_list, model, data_fund, user_dict, fund_dict, matrax, top_n=5):
    pred = {}
    # user_n x item_n
    for u in tqdm(user_list):
        ...
        u_idx = list(matrax.index.values)
        id_idx = matrax.columns.tolist()
        ...
        outputs, cos_sim, pref = model(users, items, item_asp, matrix, id_idx, u_idx) # ratings, _, _
